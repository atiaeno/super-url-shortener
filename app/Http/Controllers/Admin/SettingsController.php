...
class SettingsController extends Controller
{
    ...
    public function index(): Response
    {
        ...
        $defaults = [
            ...
            // Per-page CAPTCHA defaults
            'captcha_login' => 'false',
            'captcha_register' => 'false',
            'captcha_forgot_password' => 'false',
    ...
    public function update(Request $request)
    {
        $validated = $request->validate([
            ...
            'cache_ttl_redirect' => 'integer|min:1',
            'cache_ttl_analytics' => 'integer|min:60',
            'analytics_count_mode' => 'required|in:unique,all',
            'maintenance_mode' => 'boolean',
            'maintenance_message' => 'nullable|string',
            'captcha_enabled' => 'boolean',
            'captcha_provider' => 'nullable|in:recaptcha,turnstile,disabled',
            ...
            // Per-page CAPTCHA validation
            'captcha_login' => 'boolean',
            'captcha_register' => 'boolean',
            'captcha_forgot_password' => 'boolean',
        ...
        $settingsToSave = [
            ...
            'cache_ttl_redirect' => $validated['cache_ttl_redirect'] ?? 7,
            'cache_ttl_analytics' => $validated['cache_ttl_analytics'] ?? 3600,
            'analytics_count_mode' => $validated['analytics_count_mode'] ?? 'unique',
            ...
            'captcha_provider' => $validated['captcha_provider'] ?? 'recaptcha',
            ...
            // Per-page CAPTCHA settings
            'captcha_login' => $request->boolean('captcha_login') ? 'true' : 'false',
            'captcha_register' => $request->boolean('captcha_register') ? 'true' : 'false',
            'captcha_forgot_password' => $request->boolean('captcha_forgot_password') ? 'true' : 'false',
